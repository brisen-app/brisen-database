...
CREATE TYPE "public"."card_order" AS ENUM (
    'starting',
    'ending'
);


ALTER TYPE "public"."card_order" OWNER TO "postgres";


COMMENT ON TYPE "public"."card_order" IS 'Attribute describing when to queue card.';
...
COMMENT ON COLUMN "public"."cards"."order" IS 'Attribute describing how to queue card.';
...
COMMENT ON TABLE "public"."configurations" IS 'Default settings for the client';
...
ALTER TABLE ONLY "public"."localizations"
    ADD CONSTRAINT "localizations_language_fkey" FOREIGN KEY ("language") REFERENCES "public"."languages"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."packs"
    ADD CONSTRAINT "packs_language_fkey" FOREIGN KEY ("language") REFERENCES "public"."languages"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "Enable read access for all users" ON "public"."card_dependencies" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."card_pack_rel" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."cards" FOR SELECT TO "anon" USING (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."configurations" FOR SELECT TO "anon" USING (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."localizations" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."packs" FOR SELECT TO "anon" USING (true);
